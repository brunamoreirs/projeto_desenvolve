...
function CVPreview({ cvData }: CVPreviewProps) {
  ...
  return (
    <div className="max-w-2xl mx-auto bg-white">
      {/* Cabeçalho */}
      <div className="border-b-4 border-[#FCC6BB] pb-6 mb-6">
            ...
            {skills.map((skill) => (
              ...
              >
                ...
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-[#FCC6BB] font-mono text-sm">
              ...
              <div key={experience.id} className="relative">
                ...
                <div className="flex gap-4">
                  <div className="flex-shrink-0">
                    <div className="w-3 h-3 bg-[#FCC6BB] rounded-full mt-1"></div>
                  </div>
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-[#FCC6BB] font-medium">
                      {experience.company}
                    </p>
      ...
      <div className="border-t border-gray-200 pt-4 text-center">
        <p className="text-xs text-gray-500">
          Currículo gerado pelo Meu Currículo Inteligente
        </p>
      </div>
    </div>
  );
